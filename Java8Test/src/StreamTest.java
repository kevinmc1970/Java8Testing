...
public class StreamTest {
    ...
    Arrays.stream(new int[] { 1, 2, 3 }) // create primitive array.. 
        ...
        .average() // compute the average - this only avail because this is a primitive stream (ints)
    ...
    List<Person> persons = Arrays.asList(new Person("Max", 18), new Person("Peter", 23), new Person("Pam", 23), new Person("David", 12));
    ...
    // peek performs additional action on element as it is consumed/created by the stream 
    ...
    list.add("blue"); 
    list.add("red"); 
    // need this because lamdas can only access final variables outside of lambda which obviously can't be incremented 
